...
* Update translations, see [translation_process.md](https://github.com/chromatic/whippet-experimental-blockchain/blob/master/doc/translation_process.md#synchronising-translations). There is no Transifex project for this fork, so in practice this means whatever has been edited by hand.
...
Write release notes. git shortlog helps a lot, for example:
    ...
    git shortlog --no-merges v(current version, e.g. 1.2.0)..v(new version, e.g. 1.3.0)
...
space *do not attach these to the GitHub release*.
...
- Create a [new GitHub release](https://github.com/chromatic/whippet-experimental-blockchain/releases/new) with a link to the archived release notes, and attach the zips, installers and `SHA256SUMS.asc` from the previous step. The GitHub release is the only distribution channel: this fork has no website, download server, torrent or package repository.

- Announce the release. There is no forum, mailing list, IRC channel or
  subreddit for this fork -- the release notes and the GitHub release page are
  the announcement.
