# Contributing to Whippet Core

Whippet Core is open source software and potentially a very silly test case, not intended for serious work. Nevertheless we welcome contributions
which improve the state of the software.

## Branch Strategy

Whippet Core's default branch is intentionally a stable release, so that anyone
...
Whippet Core is a direct fork of Dogecoin Core and therefore benefits from as
little refactoring as possible on code that is created upstream.

When refactoring Whippet-specific code, please keep refactoring requests short,
...
The following applies to code changes to Whippet Core, and is not to be
confused with overall Whippet Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Whippet Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Whippet; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Whippet
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Whippet consensus, it must have been
