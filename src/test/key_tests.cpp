...
BOOST_AUTO_TEST_CASE(key_test1)
{
    ...
    const CBitcoinAddress addr1(pubkey1.GetID());
    const CBitcoinAddress addr2(pubkey2.GetID());
    const CBitcoinAddress addr1C(pubkey1C.GetID());
    const CBitcoinAddress addr2C(pubkey2C.GetID());
