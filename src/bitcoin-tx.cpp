...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s whippet-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  whippet-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded whippet transaction") + "\n" +
              "  whippet-tx [options] -create [commands]   " + _("Create hex-encoded whippet transaction") + "\n" +
              "\n";
