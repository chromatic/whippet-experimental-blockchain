...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Whippet Core repository on GitHub"),
        tr("Services that claim to double your whippets are always ponzi schemes")
    };
