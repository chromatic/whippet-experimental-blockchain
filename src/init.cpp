...
void Shutdown()
{
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // Whippet 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // Whippet: Do we need to do any RPC mining init here?
