...
/** Recommended transaction fee by Whippet Core developers
  *
 ...
 *
 *  Whippet:    Increment mempool limits and accept RBF in steps of 0.0001 WHT
...
/**
 * Whippet: Default dust limit that is evaluated when considering whether a
...
/**
 * Whippet: Default hard dust limit that is evaluated when considering whether
