...
const char * const BITCOIN_CONF_FILENAME = "whippet.conf";
const char * const BITCOIN_PID_FILENAME = "whippetd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Whippet";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Whippet";
#else
    // Unix
    return pathRet / ".whippet";
#endif
#endif
}
