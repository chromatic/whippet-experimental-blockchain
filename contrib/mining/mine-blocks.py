#!/usr/bin/env python3
"""
Mine blocks on the Whippet network at a steady pace.
...
def mine_blocks(rpc_url, num_blocks=100, mining_address=None, recipient_addresses=None,
                enable_transactions=False, block_interval=3):
...
Examples:
  # Mine 100 blocks, one every 6 seconds
  ...
  python3 mine-blocks.py -n 10 -c addresses.json --regtest
    ...
    parser.add_argument('--interval', type=int, default=3,
                        help='Seconds to wait between blocks (default: 3)')
