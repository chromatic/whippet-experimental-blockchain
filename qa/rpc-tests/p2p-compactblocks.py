...
# TestNode: A peer we use to send messages to whippetd, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes whippetd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that whippetd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for whippetd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # whippetd will not send blocktxn responses for blocks whose height is
